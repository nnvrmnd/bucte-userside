...
<body>
	...
	<div class="breadcrumb-area bg-img bg-overlay jarallax mb-3"
		...
		<div class="container-fluid">
			<div class="google-maps-contact-content">
				...
				<div class="google-maps">
					<iframe class="contact-embed" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</section>
					...
					<div class="single-widget-area mb-100 box-shadow">
						<div class="list-area">
							...
							<div style="margin-left: 4%">
								...
								<p>A Center for Teaching Excellence that promotes innovative instructional practices.
								</p>
								...
								<p>The Center seeks to advance responsive, research-based, technology-enhanced, and
									outcomes-based teaching and learning practices.</p>
