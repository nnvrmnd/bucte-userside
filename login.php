    ...
    <div class="modal fade" id="EVFailedModal" tabindex="-1" role="dialog" aria-labelledby="EVFailedModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background-color: #e8f1f8;">
                ...
                <form class="roberto-contact-form" id="evf_form">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control text-dark" placeholder="Email" name="evf_email">
                            <small class="evf_email"></small>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn roberto-btn px-5">Send verification email</button>
                    </div>
                </form>
            </div>
        </div>
